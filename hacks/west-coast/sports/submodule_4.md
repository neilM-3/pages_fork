    ...
    <div class="container">
        ...
        <div class="interactive-section">
            ...
            <div class="team-buttons">
                <button class="team-btn seahawks" onclick="loadTeamData('seahawks')">
                    🏈 Seattle Seahawks<br><small>NFL Football</small>
                </button>
                <button class="team-btn mariners" onclick="loadTeamData('mariners')">
                    ⚾ Seattle Mariners<br><small>MLB Baseball</small>
                </button>
                <button class="team-btn kraken" onclick="loadTeamData('kraken')">
                    🏒 Seattle Kraken<br><small>NHL Hockey</small>
                </button>
                <button class="team-btn huskies" onclick="loadTeamData('huskies')">
